...
const Images = {
  ...
  // *Icons
  user: require('./images/User_Icon.svg').default,
  lock: require('./images/Lock_Icon.svg').default,
  missionActive: require('./images/My_Missions_Active.svg').default,
  // missionInactive: require('./images/My_Missions_Inactive.svg').default,
  // thoughtActive: require('./images/My_Thoughts_Active.svg').default,
  thoughtInactive: require('./images/My_Thoughts_Inactive.svg').default,
  settingActive: require('./images/settings_active.svg').default,
